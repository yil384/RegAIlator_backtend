...
const envVarsSchema = Joi.object()
  .keys({
    ...
    IMAP_HOST: Joi.string().required().description('IMAP email host, e.g., imap.gmail.com'),
    IMAP_PORT: Joi.number().default(993).description('IMAP email port, typically 993 for SSL'),
    EMAIL_USER: Joi.string().description('username for email server'),
